            ...
            <tr>
                <td>
                    <dl>
                        ...
                        <dd><button type="button" id="linkValue" onclick="addToCart('cart.do')">장바구니에 담기</button></dd>
                        <dd><button type="button" id="linkValue" onclick="submitForm('purchase_info.do')">바로 주문</button></dd>
                    </dl>
                </td>
            </tr>
        </table>
